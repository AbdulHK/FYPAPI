...
class Restaurant(db.Model):
    ...
    has_delivery = db.Column(db.String(1))
    has_parking = db.Column(db.String(1))
    has_wifi = db.Column(db.String(1))
    has_reservation = db.Column(db.String(1))
    has_cards = db.Column(db.String(1))
    has_bar = db.Column(db.String(1))
    has_terrace = db.Column(db.String(1))
